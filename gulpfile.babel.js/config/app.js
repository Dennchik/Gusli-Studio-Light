...
export default {
	...
	webpack: {
		...
		entry: {
			index: { import: ['./#src/js/index.js'], dependOn: ['anime-vendors', 'swiper-bundle'], filename: '[name].min.js' },
			main: { import: ['./#src/js/main.js'], dependOn: ['anime-vendors', 'swiper-bundle'], filename: '[name].min.js' },

			// 'react-vendors': { import: ['react', 'react-dom', 'react-router-dom', 'prop-types'] },
			'anime-vendors': { import: ['gsap', 'animejs', 'gsap/ScrollSmoother', 'gsap/ScrollTrigger'], filename: 'app/[name].min.js' },
			'swiper-bundle': { import: ['swiper/bundle'], filename: 'app/[name].min.js' }
